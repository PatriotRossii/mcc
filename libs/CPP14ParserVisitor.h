...
public:
   ...
   */
    ...
    virtual antlrcpp::Any visitSimpleTypeLengthModifier(CPP14Parser::SimpleTypeLengthModifierContext *context) = 0;

    virtual antlrcpp::Any visitSimpleTypeSignednessModifier(CPP14Parser::SimpleTypeSignednessModifierContext *context) = 0;
