...
public:
  ...
  virtual antlrcpp::Any visitSimpleTypeLengthModifier(CPP14Parser::SimpleTypeLengthModifierContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual antlrcpp::Any visitSimpleTypeSignednessModifier(CPP14Parser::SimpleTypeSignednessModifierContext *ctx) override {
    return visitChildren(ctx);
  }
